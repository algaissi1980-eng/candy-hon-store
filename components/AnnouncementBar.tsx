  ...
  return (
    <div className="flex flex-col items-center gap-3 my-4 z-10 relative">
      ...
      >
        ...
        {/* Facebook */}
        <motion.a
          href="https://www.facebook.com/profile.php?id=61572556828701"
          target="_blank"
          rel="noopener noreferrer"
          title="Facebook"
          className="w-32 h-32 rounded-2xl bg-[#1877F2]/10 border border-[#1877F2]/25 flex items-center justify-center hover:bg-[#1877F2] hover:border-transparent hover:shadow-lg hover:shadow-[#1877F2]/30 transition-all duration-300 group"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
        >
          <svg viewBox="0 0 24 24" className="w-16 h-16 fill-[#1877F2] group-hover:fill-white transition-colors duration-300">
